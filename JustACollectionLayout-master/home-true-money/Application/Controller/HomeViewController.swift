...
extension HomeViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case HomeCollectionViewLayout.Component.overlayCell.kind:
            ...
            (supplementaryView as? OverlayView)?.actionDelegate = self
            return supplementaryView
...
extension HomeViewController: ActionDelegate {
    ...
    func topUpClick() {
        ...
        let flutterViewController =
            FlutterViewController(nibName: nil, bundle: nil)
        
        flutterViewController.setInitialRoute("miniapp")
        
        flutterEngine.run(withEntrypoint: nil)
        GeneratedPluginRegistrant.register(with: flutterEngine)
        
        let batteryChannel = FlutterMethodChannel(name: "dat.duong.miniapp/battery",
        ...
        batteryChannel.setMethodCallHandler({
          (call: FlutterMethodCall, result: @escaping FlutterResult) -> Void in
            ...
            self.receiceUserName(result: result)
        })
    ...
    func withDrawClick() {
        ...
        flutterViewController.setInitialRoute("miniapp2")
    ...
    private func receiceUserName(result: FlutterResult) {
        result("Duong Thanh Dat")
    }
