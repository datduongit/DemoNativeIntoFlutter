...
class IconsBloc {
  ...
  Stream<bool> get favoritesNotification => _publishSubjectNotifyFavorites.stream;

  Stream<bool> get cartNotification => _publishSubjectNotifyCart.stream;

  Stream<bool> get profileNotification => _publishSubjectNotifyProfile.stream;
